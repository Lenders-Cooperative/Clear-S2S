...
class TestUtils(TestCase):
    ...
    # def test_web_and_social_media_search(self):
    #     flags = {
    #         'first_name': 'Stephen',
    #         'last_name': 'Lightcap',
    #         'middle_name': 'Andrew',
    ...
    #     response1, response2 = self.client.social_media_search(**flags)
    #     assert response1.status_code == 200
    #     assert 'https://' in response1.find('ns2:WebAndSocialMediaSearchResults').get('Uri')
    #     assert response2 is not None
